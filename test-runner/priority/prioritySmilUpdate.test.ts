...
test.describe('prioritySmilUpdate.smil test', () => {
	test('SMIL update during priority playback cancels and reloads correctly', async ({ page, context, smilUrls, monitor }) => {
		...
		monitor.watch(durationCandidates('prioritySmilUpdate'));
