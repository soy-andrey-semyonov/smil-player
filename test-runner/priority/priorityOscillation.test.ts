...
test.describe('priorityOscillation.smil test', () => {
	test('low-priority content recovers correctly through multiple high-priority windows', async ({ page, context, smilUrls, monitor }) => {
		...
		monitor.watch(durationCandidates('priorityOscillation'));
