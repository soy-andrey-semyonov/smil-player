...
test.describe('priorityPause.smil test', () => {
	test('lower-priority content pauses and resumes when higher-priority ends', async ({ page, context, smilUrls, monitor }) => {
		...
		monitor.watch(durationCandidates('priorityPause'));
