...
export const Timeouts = {
	...
	/** First appearance of a lower-priority element AFTER the WIDEST
	 *  higher-priority wallclock windows close (+90s, used only by
	 *  priorityLower{Stop,Pause}). Must outlast that window plus the
	 *  post-close traversal tail regardless of how early a warm asset
	 *  cache lets the preamble finish — a shorter wait (priorityTransition)
	 *  races the window close on fast warm-cache boots and flakes. */
	priorityWideWindowRelease: 100000,
...
export function getSmilUrls(port: number = 3000) {
	...
	return {
		...
		priorityStuckGallery: `${base}/dynamic/priorityStuckGallery.smil`,
		priorityConditionalPhantom: `${base}/dynamic/priorityConditionalPhantom.smil`,
		...
		priorityPeerNever: `${base}/dynamic/priorityPeerNever.smil`,
		...
		wallclockEndBoundary: `${base}/wallclock/wallclockEndBoundary.smil`,
		...
		videoBackground: `${base}/playback/videoBackground.smil`,
		...
		defaultTransition: `${base}/transitions/defaultTransition.smil`,
		...
		updateContentOnHttpStatus: `${base}/reporting/updateOnHttpStatus.smil`,
		http503NoFallback: `${base}/reporting/http503NoFallback.smil`,
		httpMultiSkip: `${base}/reporting/httpMultiSkip.smil`,
		standardReporting: `${base}/reporting/standardReporting.smil`,
		standardManualReporting: `${base}/reporting/standardManualReporting.smil`,
		reportModeBatch: `${base}/reporting/reportModeBatch.smil`,
		reportFileLimitRollover: `${base}/reporting/reportFileLimitRollover.smil`,
		offlineReportUpload: `${base}/reporting/offlineReportUpload.smil`,
		updateCheckInterval: `${base}/reporting/updateCheckInterval.smil`,
		movedContentDedup: `${base}/reporting/movedContentDedup.smil`,
