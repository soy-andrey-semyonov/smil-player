...
/**
 * Consecutive cmd-wait starvation timeouts (networkFailureTimeout each) before a
 * slave region stops crawling the resync ladder and escalates to standalone
 * free-run playback. Live-observed 2026-07-10: with a dead master the slave
 * advanced one syncIndex per minute forever, screen frozen, no recovery.
 */
export const STARVATION_ESCALATION_LIMIT = 3;
